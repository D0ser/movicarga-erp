...
import { format, subMonths, parseISO, isWithinInterval, addMonths, eachMonthOfInterval } from "date-fns";
...
export default function DashboardPage() {
	...
	const datosTendenciaRentabilidad = useMemo(() => {
		...
		const datosRentabilidad = [68000, 72000, 65000, 74000, 82000, 78000, 85000, 90000, 87000, 92000, 96000, 98000];

		const datosCostos = [45000, 48000, 42000, 47000, 55000, 52000, 54000, 58000, 57000, 59000, 62000, 64000];
		...
		const datosPorcentaje = datosRentabilidad.map((ingreso, index) => (((ingreso - datosCostos[index]) / ingreso) * 100).toFixed(2));
				...
				<>
					...
					<div className="mt-8">
						...
						<div className="bg-white p-6 rounded-lg shadow-md mb-8">
							<h3 className="text-lg font-semibold mb-4">Tendencia de Rentabilidad (Últimos 12 meses)</h3>
							<Line
						...
						<div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
							...
							<div className="bg-white p-6 rounded-lg shadow-md">
								<h3 className="text-lg font-semibold mb-4">Distribución de Rentabilidad por Cliente</h3>
								<PolarArea
									data={datosRentabilidadClientes}
									options={{
										responsive: true,
