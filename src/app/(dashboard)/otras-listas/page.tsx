		...
		<div className="space-y-6">
			...
			{tablaActiva === "series" ? (
				<div className="space-y-6">
					...
					{/* Modal de Series */}
					<Modal isOpen={showFormSeries} onClose={() => setShowFormSeries(false)} title={formDataSeries.id ? "Editar Serie" : "Nueva Serie"} size="md">
						<form onSubmit={handleSubmitSeries} className="space-y-4">
							...
							<div>
								...
								<div className="flex mt-1">
									<input type="color" name="color" value={formDataSeries.color || "#3b82f6"} onChange={handleInputChangeSeries} className="h-10 w-10 border border-gray-300 rounded-md shadow-sm" />
									<input
										type="text"
										name="color"
				...
				<div className="space-y-6">
					...
					<Modal isOpen={showFormObservaciones} onClose={() => setShowFormObservaciones(false)} title={formDataObservaciones.id ? "Editar Observación" : "Nueva Observación"} size="md">
					...
					<DataTable columns={columnasObservaciones} data={observaciones} title="Observaciones" isLoading={loading} />
				</div>
			)}
		</div>
	);
