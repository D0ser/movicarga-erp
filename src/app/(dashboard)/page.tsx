    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4">
        ...
        <MiniCard
          ...
          value={stats.viajesEnRuta}
          color="bg-primary bg-opacity-10 text-primary"
        />
        <MiniCard
          title="Viajes Programados"
          value={stats.viajeProgramados}
        ...
        <MiniCard
          ...
          value={stats.detracciones.pendientes}
          color="bg-secondary bg-opacity-10 text-secondary"
        />
        <MiniCard
          title="Próx. Mantenimientos"
          value={stats.proximosMantenimientos}
...
function ActionItem({
  ...
  return (
    <div className={`flex items-center border-l-4 ${colorClass} pl-3 py-2`}>
      ...
      <div>
        {priority === 'high' && (
          <span className="px-2 py-1 bg-red-100 text-red-800 text-xs rounded-full">Alta</span>
        )}
        {priority === 'medium' && (
          <span className="px-2 py-1 bg-secondary bg-opacity-10 text-secondary text-xs rounded-full">
            Media
          </span>
        )}
        {priority === 'low' && (
          <span className="px-2 py-1 bg-green-100 text-green-800 text-xs rounded-full">Baja</span>
        )}
      </div>
    </div>
  );
