...
export default function ViajesTable({
  ...
  const deleteConfirm = useConfirmDialog({
    ...
    description: '¿Está seguro de eliminar este viaje?',
    type: 'error',
    variant: 'destructive',
                  ...
                  {(searchTerm ? filteredViajes : viajes).map((viaje) => (
                    <TableRow key={viaje.id}>
                      <TableCell className="font-medium">
                        {viaje.cliente?.razon_social || getClienteNombre(viaje.cliente_id)}
                      </TableCell>
                      <TableCell>
                      ...
                      <TableCell>
                        {viaje.conductor?.nombres
                          ...
                          : getConductorNombre(viaje.conductor_id)}
                      </TableCell>
                      <TableCell>
                        {viaje.vehiculo?.placa || getVehiculoPlaca(viaje.vehiculo_id)}
                      </TableCell>
      ...
      <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
        <DialogContent className="max-w-2xl">
          <DialogHeader>
            ...
            <DialogDescription>
              {selectedViaje
                ? 'Actualice los detalles del viaje seleccionado'
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <FormField
                ...
                name="tarifa"
                type="number"
                value={formData.tarifa?.toString()}
                onChange={handleInputChange as any}
                required
              />
              ...
              <FormField
                ...
                name="adelanto"
                type="number"
                value={formData.adelanto?.toString()}
                onChange={handleInputChange as any}
              />
