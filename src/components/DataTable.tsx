        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center space-y-2 sm:space-y-0">
          ...
          <div className="flex space-x-2 self-end">
            ...
            <button
              ...
              className="bg-[#ff5722] text-white px-3 py-1.5 rounded hover:bg-[#e64a19] text-sm flex items-center"
            ...
            paginatedData.map((item, index) => (
              ...
              >
                <div className="space-y-4">
                  {columns.map((column) =>
                    column.header !== 'Acciones' ? (
                      <div key={`${item.id}-${column.accessor}`} className="space-y-1">
                      ...
                      <div
                        ...
                        className="mt-6 pt-4 border-t border-gray-100 flex flex-wrap gap-2 justify-center"
                      >
                        {(() => {
                          const cellContent = column.cell
                            ? (column.cell(item[column.accessor], item as T) as React.ReactElement)
                            : null;
                              ...
                              (child: React.ReactElement, btnIndex: number) => {
                                ...
                                return (
                                  <button
                                    ...
                                    className={`${bgColor} ${textColor} ${hoverBgColor} px-4 py-2 rounded-lg text-sm font-medium shadow-sm transition-all duration-200 flex items-center gap-2`}
          ...
          <div className="flex flex-col">
            ...
            <div className="flex flex-col sm:flex-row gap-1">
              ...
              <div className="relative flex-grow">
                ...
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className="h-4 w-4 text-gray-500 absolute left-2 top-2.5"
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
                >
